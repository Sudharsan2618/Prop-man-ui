...
import {
  ...
  StatusBadge, Avatar, TabNav, ConfirmModal, Skeleton, PermissionGate,
} from '../../components'
...
import './ManagerPaymentReview.css'

export default function ManagerPaymentReview() {
  const { user } = useRole()
  const navigate = useNavigate()
  const { handleTabChange: _navTabChange } = useNavigation()
  const [contentTab, setContentTab] = useState('rent')
  const [navTab, setNavTab] = useState('finance')
  ...
  return (
    <PageShell
      ...
      bottomNav={<BottomNav role="manager" activeTab={navTab} onTabChange={handleNavChange} />}
    >
